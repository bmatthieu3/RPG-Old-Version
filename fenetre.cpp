...
Fenetre::Fenetre(const std::string& titre, const unsigned int width, const unsigned int height, const sf::Vector2< int >& pos)
{
    _textures = new sf::Texture[N_SPRITES_FENETRE];
    _sprites = new sf::Sprite[N_SPRITES_FENETRE];
...
sf::Vector2< int >& Fenetre::getSize() const
{
    sf::Vector2< int > size(_width, _height + _textures[ENTETE].getSize().y);
...
void Fenetre::setDimensions(const unsigned int width, const unsigned int height)
{
    ...
    _sprites[ENTETE].setPosition(sf::Vector2< float >(_pos) + sf::Vector2< float >(_textures[HG].getSize().x, OFFSET_ENTETE_Y));

    _sprites[QUITTER].setPosition(sf::Vector2< float >(_sprites[HD].getPosition().x, _pos.y + OFFSET_ENTETE_Y));

    _titre.setPosition(sf::Vector2< float >(_pos) + sf::Vector2< float >(_textures[HD].getSize().x, 0));
}

void Fenetre::setPosition(const sf::Vector2< int >& pos)
{
    _pos = pos;
}
...
void Fenetre::evenement_quitter(const sf::Vector2< int >& mouse_clic)
{
    if(_actif)
    {
    ...
    if(_actif)
    {
        ...
        while(_sprites[ENTETE].getPosition().x < _sprites[HD].getPosition().x)
        {
            if(_sprites[HD].getPosition().x - _sprites[ENTETE].getPosition().x < _textures[ENTETE].getSize().x || _sprites[BD].getPosition().y - _sprites[ENTETE].getPosition().y < _textures[ENTETE].getSize().y)
            {
                ...
                vertexArray_entete[1].position =  sf::Vector2< float >(_sprites[HD].getPosition().x, _sprites[ENTETE].getPosition().y);

                if(_sprites[BD].getPosition().y - _sprites[ENTETE].getPosition().y < _textures[ENTETE].getSize().y)
                {
                    vertexArray_entete[2].position =  sf::Vector2< float >(_sprites[HD].getPosition().x, _sprites[BD].getPosition().y);
                    vertexArray_entete[3].position =  sf::Vector2< float >(_sprites[ENTETE].getPosition().x, _sprites[BD].getPosition().y);
                }
                else
                {
                    vertexArray_entete[2].position =  sf::Vector2< float >(_sprites[HD].getPosition().x, _sprites[ENTETE].getPosition().y + _textures[ENTETE].getSize().y);
                    vertexArray_entete[3].position =  sf::Vector2< float >(_sprites[ENTETE].getPosition().x, _sprites[ENTETE].getPosition().y + _textures[ENTETE].getSize().y);
                }

                vertexArray_entete[0].texCoords =  sf::Vector2< float >(0, 0);
                vertexArray_entete[1].texCoords =  sf::Vector2< float >(_sprites[HD].getPosition().x - _sprites[ENTETE].getPosition().x, 0);

                if(_sprites[BD].getPosition().y - _sprites[ENTETE].getPosition().y < _textures[ENTETE].getSize().y)
                {
                    vertexArray_entete[2].texCoords =  sf::Vector2< float >(_sprites[HD].getPosition().x - _sprites[ENTETE].getPosition().x, _sprites[BD].getPosition().y - _sprites[ENTETE].getPosition().y);
                    vertexArray_entete[3].texCoords =  sf::Vector2< float >(0, _sprites[BD].getPosition().y - _sprites[ENTETE].getPosition().y);
                }
                else
                {
                    vertexArray_entete[2].texCoords =  sf::Vector2< float >(_sprites[HD].getPosition().x - _sprites[ENTETE].getPosition().x, _textures[ENTETE].getSize().y);
                    vertexArray_entete[3].texCoords =  sf::Vector2< float >(0, _textures[ENTETE].getSize().y);
                }
            ...
            _sprites[ENTETE].setPosition(_sprites[ENTETE].getPosition() + sf::Vector2< float >(_textures[ENTETE].getSize().x, 0));
        }
